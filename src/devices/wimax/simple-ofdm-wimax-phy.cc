                                       ...
                                       uint32_t symbolIndex)
{
  ...
  Simulator::Schedule (m_blockTime, &SimpleOfdmWimaxPhy::EndSendFecBlock, this, modulationType, direction, symbolIndex);
...
{
  /*adding one extra nano second to cope with the loss of precision problem.
  ...
  return Seconds (DoGetNrSymbols (size, modulationType) * GetSymbolDuration ().GetSeconds ()) + NanoSeconds (1);
}
